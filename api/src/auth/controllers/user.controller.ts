import {
  Body, Controller, Get, Param, Post, Put, Request, Res, UploadedFile,
  UseGuards,
  UseInterceptors
} from '@nestjs/common';
...
import {
  isFileExtensionSafe, removeFile, saveImageToStorage
...
export class UserController {
  ...
  @UseGuards(JwtGuard)
  @Get('image')
  findImage(@Request() req, @Res() res): Observable<{record:string}> {
    const userId = req.user.id;
